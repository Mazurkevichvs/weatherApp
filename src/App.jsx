...
function App() {
  ...
  return (
    <div className="App">
      ...
      {isLoading && <SpinnerCircular size={90} thickness={100} speed={100} color="rgba(255, 255, 255, 1)" secondaryColor="rgba(0, 0, 0, 0.39)" />}
      {dailyWeather && !error && <Main time={time} currentWeather={currentWeather} dailyWeather={dailyWeather}/>}
